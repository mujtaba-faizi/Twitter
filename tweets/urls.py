...
urlpatterns = [
    ...
    path('<int:logged_user_id>/users/', views.show_users, name='show_all_users'),
    path('<int:logged_user_id>/users/<int:user_id>/follow', views.add_follower, name='add_follower'),
